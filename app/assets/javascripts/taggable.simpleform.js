...
if (removable) {
$(el).append('<a href="" class="tag_action glyphicon glyphicon-remove"></a>')
}
}
...
$("div#act-as-taggable-dynamic-new_context_form a").addClass('glyphicon glyphicon-plus-sign')
$("div#act-as-taggable-dynamic-new_context_form a").text("")
$("ul#user_tag_context_form li div.field a.tag_action").on('click', function() {
